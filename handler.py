...
def transcribe_audio(audio_data):
    ...
    with io.BytesIO(audio_data) as audio_file:
        ...
        response = openai_client.audio.transcriptions.create(model="whisper-1", file=audio_file, language="fr")
...
def generate_chat_completion(messages):
    response = openai_client.chat.completions.create(
        model="davinci:ft-tensei-2024-01-05-19-52-15",
        messages=messages,
...
def generate_audio(generated_text):
    # API key
    api_key = "96984d155bc447a406bc8218d8967266"

    # Voice id
    voice_id = "ApTouURZhor0yAAQjj3F"
